...
async def play_audio_after_delay_welcome(client, char, camera=None, classifier=None):
...
async def play_audio_after_delay_speed_report(client, char, camera=None, classifier=None):
    await display_emotions.display_emotion(client, char, "happy")
    await asyncio.sleep(1)
...
async def play_audio_after_delay_construction(client, char, camera=None, classifier=None):
    #surprise
...
#traffic jam
async def play_audio_after_delay_traffic_jam(client, char, camera=None, classifier=None):
    #sadness
